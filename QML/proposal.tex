...
애론슨{\footnotesize Scott Aaronson}의 서베이 \snm{세부조항을 
읽어라}{\footnotesize(Read the fine print, Nature Physics 2015)}에 따르면
...
탕은 위와 같은 내용을 담은 학부 졸업논문 \snm{추천 시스템에 대한 양자적 영향상의
